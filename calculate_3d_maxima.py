...
# ==========================================
# Dynamically scale the grid based on X so the plot always looks proportional
grid_max = X_val * 1.2
...
print("\nSuccess! Saved graph as 3D_Maxima_General.png inside IRS_Secure_Sensing_Project")
