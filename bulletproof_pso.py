...
def calculate_penalty(x_vals):
    ...
    # 2. THE BULLETPROOF CONSTRAINT: Line of Sight Check
...
ax1.set_title('Bulletproof Swarm Convergence', fontweight='bold')
...
plt.savefig('Bulletproof_PSO.png', dpi=300, bbox_inches='tight')
print(f"\nSuccess! Bulletproof Algorithm found X = {g_best_x:.3f}m.")
